...
#define kActionSheetColor            [UIColor colorWithRed:245.0f/255.0f green:245.0f/255.0f blue:245.0f/255.0f alpha:0.85f]
...
- (UIImage *)normalImage {
    ...
    if (!_normalImage) {
        _normalImage = [self imageFromColor:[UIColor colorWithWhite:1.0 alpha:0.8]];
    }
    return _normalImage;
}
...
- (void)setupCover {
    ...
    [self addSubview:({
        ...
        cover.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.4];
        cover.alpha = 0;
